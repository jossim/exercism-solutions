...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    efficient = 100 * generated_power / theoretical_max_power
    efficient_code = 'black'

    if efficient >= 80:
        efficient_code = 'green'
    elif 80 > efficient >= 60:
        efficient_code = 'orange'
    elif 60 > efficient >= 30:
        efficient_code = 'red'

    return efficient_code
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    percentage = 100 * criticality / threshold

    fail_safe_value = 'DANGER'

    if percentage < 90:
        fail_safe_value = 'LOW'
    elif 110 >= percentage >= 90:
        fail_safe_value = 'NORMAL'
